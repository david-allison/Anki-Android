            ...
            fun buildFieldSpinner(spinnerIndex: Int) =
                Spinner(requireContext())
                    .apply {
                        ...
                        val fieldSpinnerOptions = inputFieldNames + "(${getString(R.string.nothing)})"
            ...
            fun buildTemplateSpinner(spinnerIndex: Int) =
                Spinner(requireContext())
                    .apply {
                        ...
                        val templateSpinnerOptions = inputTemplateNames + "(${requireContext().getString(R.string.nothing)})"
