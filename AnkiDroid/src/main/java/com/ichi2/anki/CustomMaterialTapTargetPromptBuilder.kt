...
import com.ichi2.anki.DimmedPromptBackgroundAdapter.Companion.castToPromptBackground
import com.ichi2.utils.DimmedPromptBackground
...
class CustomMaterialTapTargetPromptBuilder<T>(val mActivity: Activity, val mFeatureIdentifier: T) : MaterialTapTargetPrompt.Builder(mActivity) where T : Enum<T>, T : OnboardingFlag {
    ...
    fun createRectangleWithDimmedBackground(): CustomMaterialTapTargetPromptBuilder<T> {
        promptBackground = DimmedPromptBackground(RectanglePromptBackground()).castToPromptBackground()
    ...
    fun createCircleWithDimmedBackground(): CustomMaterialTapTargetPromptBuilder<T> {
        promptBackground = DimmedPromptBackground(CirclePromptBackground()).castToPromptBackground()
        return createCircle()
    }
