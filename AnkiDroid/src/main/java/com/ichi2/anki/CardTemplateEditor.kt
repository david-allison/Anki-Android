...
open class CardTemplateEditor :
    ...
    private lateinit var binding: CardTemplateEditorBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = CardTemplateEditorBinding.inflate(layoutInflater)
         ...
         */
        fragmented = binding.fragmentContainer?.visibility == View.VISIBLE
    ...
    class CardTemplateFragment : Fragment() {
        ...
        private var fragmentBinding: CardTemplateEditorItemBinding? = null
        internal val binding: CardTemplateEditorItemBinding
            get() = fragmentBinding!!
        ...
        override fun onCreateView(
            ...
            fragmentBinding = CardTemplateEditorItemBinding.inflate(inflater, container, false)
