 ...
 * @param type The data type displayed by the column
 */
...
fun ColumnType.humanReadableExplanation(descending: Boolean): Int =
    if (descending) {
        when (this) {
            ...
            ColumnType.DATE, ColumnType.UNSPECIFIED -> R.string.card_browser_order_subtitle_date_descending
        }
    } else {
        when (this) {
            ...
            ColumnType.DATE, ColumnType.UNSPECIFIED -> R.string.card_browser_order_subtitle_date_ascending
        }
    }
