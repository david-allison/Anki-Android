...
class FindAndReplaceDialogFragment : AnalyticsDialogFragment() {
    ...
    private fun FragmentFindReplaceBinding.setupLabels() {
        labelFind.text =
        ...
        onlySelectedNotes.text = TR.browsingSelectedNotesOnly()
        checkIgnoreCase.text = TR.browsingIgnoreCase()
        checkInputAsRegex.text =
    ...
    override fun onStart() {
        ...
        lifecycleScope.launch {
            ...
            binding.onlySelectedNotes.isChecked = noteIds.isNotEmpty()
            binding.onlySelectedNotes.isEnabled = noteIds.isNotEmpty()
            val fieldsNames =
                buildList {
                    add(
    ...
    fun startFindReplace() {
        ...
        val onlyInSelectedNotes = binding.onlySelectedNotes.isChecked
        val ignoreCase = binding.checkIgnoreCase.isChecked
        val inputAsRegex = binding.checkInputAsRegex.isChecked
        val selectedField =
