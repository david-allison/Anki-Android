...
import com.ichi2.anki.databinding.SettingsFragmentBinding
...
abstract class SettingsFragment :
    ...
    protected var fragmentBinding: SettingsFragmentBinding? = null
        private set
    protected val binding get() = fragmentBinding!!
