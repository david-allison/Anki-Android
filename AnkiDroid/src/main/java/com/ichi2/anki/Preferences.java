                ...
                try {
                    ...
                    switch (pref.getKey()) {
                        ...
                        case SHOW_PROGRESS:
                            ...
                            break;
                        case LEARN_CUTOFF:
                            ((NumberRangePreferenceCompat)pref).setValue(conf.getInt("collapseTime") / 60);
                            break;
                        case TIME_LIMIT:
                            ((NumberRangePreferenceCompat)pref).setValue(conf.getInt("timeLim") / 60);
                            break;
                        case USE_CURRENT:
                        ...
                        case DAY_OFFSET:
                            ...
                            break;
                        case PASTE_PNG:
                            ((CheckBoxPreference)pref).setChecked(conf.optBoolean("pastePNG"));
                            break;
            ...
            try {
                ...
                switch (key) {
                    ...
                    case LANGUAGE:
                        ...
                        break;
                    case SHOW_PROGRESS:
                        preferencesActivity.getCol().getConf().put("dueCounts", ((CheckBoxPreference) pref).isChecked());
                        preferencesActivity.getCol().setMod();
                        break;
                    case SHOW_ESTIMATE:
                        preferencesActivity.getCol().getConf().put("estTimes", ((CheckBoxPreference) pref).isChecked());
                        preferencesActivity.getCol().setMod();
                        break;
                    case NEW_SPREAD:
                        preferencesActivity.getCol().getConf().put("newSpread", Integer.parseInt(((ListPreference) pref).getValue()));
                        preferencesActivity.getCol().setMod();
                        break;
                    case TIME_LIMIT:
                        preferencesActivity.getCol().getConf().put("timeLim", ((NumberRangePreferenceCompat) pref).getValue() * 60);
                        preferencesActivity.getCol().setMod();
                        break;
                    case LEARN_CUTOFF:
                        preferencesActivity.getCol().getConf().put("collapseTime", ((NumberRangePreferenceCompat) pref).getValue() * 60);
                        preferencesActivity.getCol().setMod();
                        break;
                    case USE_CURRENT:
                        preferencesActivity.getCol().getConf().put("addToCur", "0".equals(((ListPreference) pref).getValue()));
                        preferencesActivity.getCol().setMod();
                        break;
                    case DAY_OFFSET: {
                    ...
                    case PASTE_PNG:
                        preferencesActivity.getCol().getConf().put("pastePNG", ((CheckBoxPreference) pref).isChecked());
                        preferencesActivity.getCol().setMod();
                        break;
                    case MINIMUM_CARDS_DUE_FOR_NOTIFICATION: {
                        ListPreference listpref = (ListPreference) screen.findPreference(MINIMUM_CARDS_DUE_FOR_NOTIFICATION);
                        if (listpref != null) {
