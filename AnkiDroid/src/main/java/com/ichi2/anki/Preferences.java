            ...
            try {
                ...
                switch (key) {
                    ...
                    case LANGUAGE:
                        ...
                        break;
                    case SHOW_PROGRESS:
                        preferencesActivity.getCol().getConf().put("dueCounts", ((android.preference.CheckBoxPreference) pref).isChecked());
                        preferencesActivity.getCol().setMod();
                        break;
                    case SHOW_ESTIMATE:
                        preferencesActivity.getCol().getConf().put("estTimes", ((android.preference.CheckBoxPreference) pref).isChecked());
                        preferencesActivity.getCol().setMod();
                        break;
                    case NEW_SPREAD:
                        preferencesActivity.getCol().getConf().put("newSpread", Integer.parseInt(((android.preference.ListPreference) pref).getValue()));
                        preferencesActivity.getCol().setMod();
                        break;
                    case TIME_LIMIT:
                        preferencesActivity.getCol().getConf().put("timeLim", ((NumberRangePreference) pref).getValue() * 60);
                        preferencesActivity.getCol().setMod();
                        break;
                    case LEARN_CUTOFF:
                        preferencesActivity.getCol().getConf().put("collapseTime", ((NumberRangePreference) pref).getValue() * 60);
                        preferencesActivity.getCol().setMod();
                        break;
                    case USE_CURRENT:
                        preferencesActivity.getCol().getConf().put("addToCur", "0".equals(((android.preference.ListPreference) pref).getValue()));
                        preferencesActivity.getCol().setMod();
                        break;
                    case DAY_OFFSET: {
                    ...
                    case PASTE_PNG:
                        preferencesActivity.getCol().getConf().put("pastePNG", ((android.preference.CheckBoxPreference) pref).isChecked());
                        preferencesActivity.getCol().setMod();
                        break;
