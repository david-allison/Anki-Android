...
class SoundPlayerTest : RobolectricTest() {
    ...
    val tagPlayer = mockk<SoundTagPlayer>()
    val ttsPlayer = mockk<TtsPlayer>()

    val onSoundGroupCompleted = mockk<() -> Unit>().also {
    ...
    fun `retry playing single sound`() = runSoundPlayerTest {
        ...
        playOneSound(SoundOrVideoTag("a.mp3"))
