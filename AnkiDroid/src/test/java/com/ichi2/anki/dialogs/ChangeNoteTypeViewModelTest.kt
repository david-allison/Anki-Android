    ...
    fun `no changes to save`() =
        ...
        viewModelTest {
            val expectedException =
                assertFailsWith<IllegalArgumentException> { executeChangeNoteTypeAsync().await() }
...
private fun ChangeNoteTypeViewModel.canMapTemplates(): Boolean = canChangeCardsFlow.value
