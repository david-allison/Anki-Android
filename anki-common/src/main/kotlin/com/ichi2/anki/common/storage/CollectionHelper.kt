...
object CollectionHelper {
     ...
     *
     * `ensureCollectionPathSet` persists the folder on startup, unless the `StoragePolicy`
     * defers the choice to the permission screen (non-Play builds on Android 11+).
     *
