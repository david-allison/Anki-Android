...
object CollectionHelper {
    ...
    /**
     * @return the path to the actual [com.ichi2.anki.libanki.Collection] file
     *
    ...
    fun getCurrentAnkiDroidDirectory(preferences: SharedPreferences): File {
        ...
        return if (isInstrumentationTest) {
            ...
            File(collectionDirectory ?: throw StorageNotConfiguredException(), "androidTest")
        } else {
            ankiDroidDirectoryOverride
                ?: File(collectionDirectory ?: throw StorageNotConfiguredException())
        }
    }
